...
namespace DbConnect.DbContext
{
    public class BaseDataAccess
    {
        ...
        public BaseDataAccess()
        {
            ...
            //.Build();
            //ConnectionString = "Data Source=db;Initial Catalog=MyTestDb;User ID=user2;Password=12345;"; //configuration.GetConnectionString("DefaultConnection");
             ConnectionString = "Persist Security Info=False;Server=db,1433;Database=MyTestDb;User=sa;Password=Password@123;";
        }
